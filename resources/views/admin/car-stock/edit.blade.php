                    ...
                    <div class="container-fluid flex-grow-1 container-p-y">
                        ...
                        <div class="col-xl">
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <form action="/admin/stock/{{ $car->id }}" method="POST"
                                        enctype="multipart/form-data">
                                        @csrf
                                        <input type="hidden" name="_method" value="PUT">
                                        <input type="text" name="car_id" id=""
                                            value="{{ request()->segment(3) }}" hidden>
                                        <div class="row">
                                            <div class="mb-3 col">
                                                <label class="form-label" for="basic-default-fullname">price</label>
                                                <input type="text" class="form-control" id="basic-default-fullname"
                                                    placeholder="price" name="price" value="{{ $carStock->price }}">
                                                @error('price')
                                            ...
                                            <div class="mb-3 col">
                                                ...
                                                <input type="text" class="form-control" id="basic-default-fullname"
                                                    placeholder="old_price" name="old_price"
                                                    value="{{ $carStock->old_price }}">
                                                @error('old_price')
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="mb-3 col">
                                                ...
                                                <select class="form-control" id="basic-default-fullname" name="status">
                                                    <option value="New"
                                                        {{ $carStock->status === 'new' ? 'selected' : '' }}>New
                                                    </option>
                                                    <option value="Used - like new"
                                                        {{ $carStock->status === 'used' ? 'selected' : '' }}>Used
                                                    </option>
                                                </select>
                                                @error('status')
                                                    <div class="text-danger">{{ $message }}</div>
                                            ...
                                            <div class="mb-3 col">
                                                ...
                                                <select class="form-control" id="basic-default-fullname"
                                                    ...
                                                    <option value="Gasoline"
                                                        {{ $carStock->fuel_type === 'Gasoline' ? 'selected' : '' }}>
                                                        Gasoline</option>
                                                    <option value="Diesel"
                                                        {{ $carStock->fuel_type === 'Diesel' ? 'selected' : '' }}>
                                                        Diesel</option>
                                                    <option value="Electricity"
                                                        {{ $carStock->fuel_type === 'Electricity' ? 'selected' : '' }}>
                                                        Electricity</option>
                                                    <option value="Hybrid"
                                                        {{ $carStock->fuel_type === 'Hybrid' ? 'selected' : '' }}>
                                                        Hybrid</option>
                                                </select>
                                                @error('fuel_type')
                                                    <div class="text-danger">{{ $message }}</div>
                                            ...
                                            <div class="mb-3 col">
                                                ...
                                                <select class="form-control" id="basic-default-fullname"
                                                    ...
                                                    <option value="Automatic"
                                                        {{ $carStock->gearbox === 'Automatic' ? 'selected' : '' }}>
                                                        Automatic</option>
                                                    <option value="Manual"
                                                        {{ $carStock->gearbox === 'Manual' ? 'selected' : '' }}>Manual
                                                    </option>
                                                    <option value="Hybrid"
                                                        {{ $carStock->gearbox === 'Hybrid' ? 'selected' : '' }}>Hybrid
                                                    </option>
                                                </select>
                                                @error('gearbox')
                                                    <div class="text-danger">{{ $message }}</div>
                                        ...
                                        <div class="row">
                                            <div class="mb-3 col">
                                                <label class="form-label" for="no_passengers">no_passengers</label>
                                                <input type="number" class="form-control" id="no_passengers"
                                                    name="no_passengers" value="{{ $carStock->no_passengers }}">
                                                @error('no_passengers')
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        {{-- <div class="mb-3 col">
                                            ...
                                            <select id="yearSelect" class="form-control" id="basic-default-fullname"
                                                name="class" value="{{ $carStock->class }}">
