            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-title">
                        ...
                        <h6 class="text-center mt-5">Total Products: {{ $products->total() }}</p>
                    </div>
                </div>
            </div>
            <form class="mt-3" action="{{ route('category.products.search', $category->id) }}" method="GET" class="form-inline">
                @csrf
