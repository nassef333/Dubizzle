...
href = "images/favicon.png" >
    ...
    <!-- Stylesheet -->
    <
    link href = "vendor/lightgallery/css/lightgallery.min.css"
rel = "stylesheet" >
    <
    link href = "vendor/magnific-popup/magnific-popup.min.css"
rel = "stylesheet" >
    <
...
rel = "stylesheet" >
    <
    link rel = "stylesheet"
href = "vendor/switcher/switcher.css" >
    <
    link href = "vendor/splitting/dist/splitting.css"
rel = "stylesheet" >
    <
...
href = "https://fonts.gstatic.com" >
    ...
    <
    link href = "https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&family=Oswald:wght@200;300;400;500;600;700&display=swap"
rel = "stylesheet" >
    <!-- Custom Stylesheet -->
    <
    link rel = "stylesheet"
href = "vendor/rangeslider/rangeslider.css" >
    <
    link rel = "stylesheet"
href = "css/style.css" >
...
class = "btn btn-primary light phone-no shadow-none effect-1" > < span > < i class = "fas fa-phone-volume shake" > < /i>224 000 22 11 33</span > < /a> <
    /div> <
    /div>
    <!-- Extra Nav -->
    <
...
data - text = "ERROR" >
    ...
    h2 class = "error-head" > We are sorry.But the page you are looking
for cannot be found. < /h2> <
    a href = "index.html"
class = "btn btn-primary effect" > < span > BACK TO HOMEPAGE < /span></a >
    <
    /div> <
    /div> <
    /section>
...
fill = "white" > < /path> <
    ...
    <
    p > 77 Highfield Road London N36 7 SB < /p> <
    /div> <
    /div> <
...
class = "text-primary"
target = "_blank" > DexignLabs < /a> All rights reserved.</span >
    <
    /div> <
    /div> <
    /div> <
