              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a href="pages-misc-error.html" class="menu-link">
                    <div data-i18n="Error">waiting Orders</div>
                  </a>
                </li>                
                <li class="menu-item">
                  <a href="pages-misc-error.html" class="menu-link">
                  ...
                  <div class="card-body">
                    <form action="/admin/product" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="basic-default-fullname" placeholder="Product" name="name" value="{{ old('name') }}">
                        @error('name')
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="basic-default-fullname" placeholder="weight" name="weight"  value="{{ old('weight') }}">
                        @error('dimensions')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                      </div>
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="basic-default-fullname" placeholder="dimensions" name="dimensions"  value="{{ old('dimensions') }}">
                        @error('dimensions')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                      </div>
                      ...
                      <div class="mb-3">
                        ...
                        <textarea id="basic-default-message" class="form-control" placeholder="Please type Product Description Here..." name="description"> {{ old('description') }}</textarea>
                        @error('description')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                      </div>
                      <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="basic-default-fullname" placeholder="quantity" name="quantity_available"  value="{{ old('quantity_available') }}">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="file" class="form-control" id="imageInput" name="image[]" accept="image/*" placeholder="Upload Image" onchange="previewImage(event)"  value="{{ old('image') }}">
                        @error('image')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                      </div>                      
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="basic-default-fullname" placeholder="price" name="price"  value="{{ old('price') }}">
                        @error('price')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                      </div>
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="basic-default-fullname" placeholder="old price" name="old_price" value="{{ old('old_price') }}">
                        @error('old_price')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                      </div>
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="basic-default-fullname" placeholder="rate" name="rate" value="{{ old('rate') }}">
                        @error('rate')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                      </div>
