            ...
            <div class="container-fluid flex-grow-1 container-p-y">
              ...
              <div class="col-xl">
                <div class="card mb-4">
                  ...
                  <div class="card-body">
                    <form action="/admin/car/{{$car->id}}" method="POST" enctype="multipart/form-data">
                      @csrf
                      <input type="hidden" name="_method" value="PUT">
                        <div class="row">
                            <div class="mb-3 col">
                                <label class="form-label" for="basic-default-fullname">Name</label>
                                <input type="text" class="form-control" id="basic-default-fullname" placeholder="name of series" name="name" value="{{$car->name}}">
                                @error('name')
                              ...
                              <div class="mb-3 col">
                                ...
                                <input type="text" class="form-control" id="basic-default-fullname" placeholder="description" name="description" value="{{$car->description}}">
                                @error('description')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                              </div>
