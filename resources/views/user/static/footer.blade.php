            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="widget widget_categories p-l50">
                        ...
                        <ul>
                            <li class="cat-item"><a href="/assets/about-us.html">About us</a></li>
                            <li class="cat-item"><a href="/assets/contact-us.html">Contact us</a></li>
                            <li class="cat-item"><a href="/assets/car-listing.html">Products</a></li>
                            <li class="cat-item"><a href="/assets/javascript:void(0);">Login</a></li>
                            <li class="cat-item"><a href="/assets/javascript:void(0);">Sign Up</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="widget widget_categories">
                        ...
                        <ul>
                            <li class="cat-item"><a href="/assets/javascript:void(0);">Affiliates</a></li>
                            <li class="cat-item"><a href="/assets/javascript:void(0);">Sitemap</a></li>
                            <li class="cat-item"><a href="/assets/javascript:void(0);">Cancelation Policy</a></li>
                            <li class="cat-item"><a href="/assets/javascript:void(0);">Privacy Policy</a></li>
                            <li class="cat-item"><a href="/assets/javascript:void(0);">Legal Disclaimer</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12">
        ...
        <div class="container">
            <div class="row align-items-center fb-inner spno">
                <div class="col-12 text-center">
                    <span class="copyright-text">Copyright © 2022 <a href="/assets/https://dexignlab.com/" class="text-primary" target="_blank">DexignLabs</a> All rights reserved.</span>
                </div>
            </div>
        </div>
    </div>
