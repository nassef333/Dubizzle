    ...
    <nav aria-label="breadcrumb" class="breadcrumb-row">
        <div class="container">
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="/cars/advanced-search">Car Collections</a></li>
                                            ...
                                            <div class="acod-content">
                                                <ul class="table-dl clearfix">
                                                    <li>
                                                        ...
                                                        <div class="rightview">{{ $car->class }}</div>
                                                    </li>
                                                    <li>
                    ...
                    <div class="sticky-top">
                        <div class="car-dl-info icon-bx-wraper style-1 m-b50">
                            ...
                            <form>
                                ...
                                <div class="clearfix">
                                    {{-- {{request()->fullUrl()}} --}}
                                    <a href="https://api.whatsapp.com/send?phone=+971589803861&text=Hello Sir,%0A{{ request()->fullUrl() }}%0A,%20I%20have%20seen%20this%20product%20on%20your%20website%20and%20I%20would%20like%20to%20know%20more%20about%20the%20details."
