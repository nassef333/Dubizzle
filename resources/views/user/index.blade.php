                    ...
                    <div class="container clearfix">
                        ...
                        <div class="extra-nav">
                            <div class="extra-cell">
                                <a href="/assets/tel:224000221133" class="btn btn-primary light phone-no shadow-none effect-1"><span><i class="fas fa-phone-volume shake"></i>224 000 22 11 33</span></a>
                            </div>
                        </div>
                        <!-- Extra Nav -->
                        <div class="header-nav navbar-collapse collapse justify-content-end" id="navbarNavDropdown">
                            ...
                            <ul class="nav navbar-nav navbar navbar-left">
                                ...
                                <li class="sub-menu-down"><a href="/cars">CARS</a>
                                </li>

                                <li class="sub-menu-down"><a href="/latest-cars">LATEST CARS</a>
                                </li>

                                <li class="sub-menu-down"><a href="/about-us">ABOUT US</a>
                                </li>

                                <li class="sub-menu-down"><a href="/contact">CONTACT</a>
                                </li>
                            </ul>
                ...
                <div class="row">
                    <div class="col-lg-6 align-self-center">
                        <div class="banner-content">
                            ...
                            <a href="/assets/car-listing.html" class="btn-link-lg">Try advanced search<i class="fa-solid fa-magnifying-glass"></i></a>
                            <div class="tags-area">
                                <p>Popular Brands</p>
                                <ul class="tag-list">
                                    <li><a href="/assets/javascript:void(0);">HONDO</a></li>
                                    <li><a href="/assets/javascript:void(0);">FORT</a></li>
                                    <li><a href="/assets/javascript:void(0);">TOYOTO</a></li>
                                    <li><a href="/assets/javascript:void(0);">PORCE</a></li>
                                </ul>
                            </div>
                                        ...
                                        <div class="dlab-slide-item">
                                            <div class="silder-content">
                                                <div class="inner-content">
                                                    <div class="left">
                                                        <p class="car-type">SPORT CAR</p>
                                                        <p class="car-name slide-vertical" data-splitting>Porce 123 GT</p>
                                                    </div>
                                                    <div class="right">
                                                ...
                                                <a href="/assets/car-listing.html" data-splitting class="discover-link">DISCOVER MORE</a>
                                            </div>
                                            <div class="slider-img">
                                                <img src="/assets/images/main-slider/pic1.jpg" alt="" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="dlab-slide-item">
                                            ...
                                            <div class="slider-img">
                                                <img src="/assets/images/main-slider/pic2.jpg" alt="" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="dlab-slide-item">
                                            ...
                                            <div class="slider-img">
                                                <img src="/assets/images/main-slider/pic3.jpg" alt="" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="icon-bx-wraper style-1 hover-overlay-effect">
                                            ...
                                            <div class="icon-content">
                                                <h4 class="title"><a href="/assets/services.html" class="text-effect-1" data-splitting>EXCLUSIVE</a></h4>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="icon-bx-wraper style-1 hover-overlay-effect">
                                            ...
                                            <div class="icon-content">
                                                <h4 class="title"><a href="/assets/services.html" class="text-effect-1" data-splitting>UPDATE</a></h4>
                                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam</p>
                                            </div>
                                            <div class="effect bg-primary"></div>
                                        </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="icon-bx-wraper style-1 hover-overlay-effect">
                                            ...
                                            <div class="icon-content">
                                                <h4 class="title"><a href="/assets/services.html" class="text-effect-1" data-splitting>SECURE</a></h4>
                                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam</p>
                                            </div>
                                            <div class="effect bg-primary"></div>
                                        </div>
                    ...
                    <div class="row features-box">
                        <div class="col-lg-6 align-self-center m-b30">
                            <div class="content-box">
                                ...
                                <p class="m-b40">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="car-list-box overlay">
                                    <div class="media-box">
                                        <img src="/assets/images/deal/pic1.jpg" alt="">
                                    </div>
                                    <div class="list-info">
                            ...
                            <div class="swiper-slide">
                                <div class="car-list-box overlay">
                                    <div class="media-box">
                                        <img src="/assets/images/deal/pic2.jpg" alt="">
                                    </div>
                                    <div class="list-info">
                            ...
                            <div class="swiper-slide">
                                <div class="car-list-box overlay">
                                    <div class="media-box">
                                        <img src="/assets/images/deal/pic3.jpg" alt="">
                                    </div>
                                    <div class="list-info">
                            ...
                            <div class="swiper-slide">
                                <div class="car-list-box overlay">
                                    <div class="media-box">
                                        <img src="/assets/images/deal/pic4.jpg" alt="">
                                    </div>
                                    <div class="list-info">
                    ...
                    <div class="row features-box">
                        ...
                        <div class="col-lg-6 align-self-center m-b30">
                            <div class="content-box right">
                                <div class="section-head">
                                    <h6 class="sub-title style-1">Best Car in The World</h6>
                                    <h2 class="title">We serve you with best car in the world</h2>
                                </div>
                                <p class="m-b40">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
                                    consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. </p>
                                <div class="video-bx style-1">
                                    <div class="video-btn">
                                        <a href="/assets/https://www.youtube.com/watch?v=PkkV1vLHUvQ" class="popup-youtube"><span class="icon"><i class="fa fa-play"></i></span>Learn more</a>
                                    </div>
                                </div>
                            </div>
                        </div>
