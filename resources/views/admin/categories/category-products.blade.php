              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  ...
                  <a href="#" class="menu-link">
                    <div data-i18n="Notifications">Category Products</div>
                  </a
                </li>
                {{-- <li class="menu-item">
...
<div class="card">
  <h2 class="card-header text-center">{{$category->name}}</h2>
  <div class="card-body">
    <div class="search mt-2 mb-5">
      <div class="buttons mb-2">
        <a href="#" type="button" class="btn btn-outline-primary btn-sm">+ Add Product</a>
      </div>
          ...
          <tr id="deleteRow{{$product->id}}">
            <td>{{ $product->id }}</td>
              ...
              <td class="text-center">
                <div class="btn-group">
                  <a href="/admin/category/products/{{$product->id}}" type="button" class="btn btn-outline-primary btn-sm">View</a>
                  <a href="/admin/product/{{$product->id}}/edit" type="button" class="btn btn-outline-primary btn-sm">Edit</a> <!-- Added btn-sm class -->
                  <button type="button" onclick="showConfirmationModal({{$product->id}})" class="btn btn-outline-danger btn-sm">Delete</button>
                </div>
              </td>
            </tr>
          @endforeach
