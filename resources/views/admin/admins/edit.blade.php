            ...
            <li class="menu-item open active">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item active">
                  <a href="#" class="menu-link">
                    <div data-i18n="Text Divider">Edit Admin</div>
                  </a>
                </li>
              </ul>
            </li>
              ...
              <div class="col-xl">
                <div class="card mb-4">
                  <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="mb-4">Edit Admin: {{$admin->name}}</h4>
                    <small class="text-muted float-end">Edit Admins</small>
                  </div>
                  <div class="card-body">
                    <form action="/admin/admin/{{$admin->id}}" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="basic-default-fullname" placeholder="name" name="name" value="{{$admin->name}}">
                        @error('name')
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="basic-default-fullname" placeholder="Enter Your Username" name="username" value="{{$admin->username}}">
                        @error('username')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                      </div>
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="basic-default-fullname" placeholder="Enter Your password" name="password">
                        @error('password')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                      </div>
                      <div class="mb-3">
                        ...
                        <select id="smallSelect" class="form-select form-select-sm" name="role" selected="{{$admin->role}}">
