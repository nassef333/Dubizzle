                ...
                <div class="col-lg-6 align-self-center">
                    <div class="banner-content">
                        ...
                        <p>Discover a world where automotive excellence and precision craftsmanship converge,
                            revolutionizing your ride and elevating your driving experience to unparalleled heights
                            with our superior quality car parts meticulously engineered for optimal performance,
                            ensuring you unleash the full potential of your vehicle and drive with unwavering
                            confidence on every journey.</p>
                        ...
                        <a href="/assets/car-listing.html" class="btn-link-lg">Try advanced search<i
                    ...
                    <div class="banner-slider">
                        <div class="swiper-container main-silder-swiper">
                                        ...
                                        <div class="silder-content">
                                            <div class="inner-content">
                                                <div class="left">
                                                    ...
                                                    <p class="car-name slide-vertical" data-splitting>Porce 123 GT
                                                    </p>
                                                </div>
                                                <div class="right">
                                            ...
                                            <a href="/assets/car-listing.html" data-splitting
                            ...
                            <div class="slider-one-pagination">
                                <div class="btn-prev swiper-button-prev1"><i class="fas fa-chevron-left"></i>
                                </div>
                                <div class="btn-next swiper-button-next1"><i class="fas fa-chevron-right"></i>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="icon-bx-wraper style-1 hover-overlay-effect">
                                        ...
                                        <div class="icon-content">
                                            <h4 class="title"><a href="/assets/services.html" class="text-effect-1"
                                                    data-splitting>EXCLUSIVE</a></h4>
                ...
                <div class="row features-box">
                    <div class="col-lg-6 align-self-center m-b30">
                        <div class="content-box">
                            ...
                            <p class="m-b40">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                    ...
                    <div class="swiper-wrapper">
                            ...
                            <div class="car-list-box overlay">
                                ...
                                <div class="list-info">
                                    <h3 class="title"><a href="/assets/car-details.html" data-splitting
                                            class="text-white">SMART GT AA-211</a></h3>
                        ...
                        <div class="swiper-slide">
                            <div class="car-list-box overlay">
                                ...
                                <div class="list-info">
                                    <h3 class="title"><a href="/assets/car-details.html" data-splitting
                                            class="text-white">GT-Z 122 Boost</a></h3>
                                    <div class="car-type">SPORT CAR</div>
                                    <span class="badge m-b30">$34,500</span>
                                    <div class="feature-list">
                                        <div>
                        ...
                        <div class="swiper-slide">
                            <div class="car-list-box overlay">
                                ...
                                <div class="list-info">
                                    <h3 class="title"><a href="/assets/car-details.html" data-splitting
                                            class="text-white">SPORT X-GTZ</a></h3>
                                    <div class="car-type">SPORT CAR</div>
                                    <span class="badge m-b30">$34,500</span>
                                    <div class="feature-list">
                                        <div>
                        ...
                        <div class="swiper-slide">
                            <div class="car-list-box overlay">
                                ...
                                <div class="list-info">
                                    <h3 class="title"><a href="/assets/car-details.html" data-splitting
                                            class="text-white">Smart Car GT AA-211</a></h3>
                                    <div class="car-type">SPORT CAR</div>
                                    <span class="badge m-b30">$34,500</span>
                                    <div class="feature-list">
                                        <div>
                    ...
                    <div class="col-lg-6 align-self-center m-b30">
                        <div class="content-box right">
                            ...
                            <div class="video-bx style-1">
                                <div class="video-btn">
                                    <a href="/assets/https://www.youtube.com/watch?v=PkkV1vLHUvQ"
