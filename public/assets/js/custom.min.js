            ...
            function () {
                ...
                jQuery(".dlabload").each(function () {
                    ...
                    jQuery(".menu-close").on("click", function () {
                        jQuery(".menu-close,.full-sidenav").removeClass(
                            "active"
                        );
                    });
            }),
        ...
        init: function () {
            jQuery(".box-hover").on("mouseenter", function () {
                    ...
                    jQuery(window).on("scroll", function () {
                        if (jQuery(".sticky-header").length > 0) {
                            ...
                            $(window).scrollTop() > e.offset().top
                                ? (e.addClass("is-fixed"),
                                  $(
                                      ".site-header .container > .logo-header .logo"
                                  ).attr("src", "images/logo.png"),
                                  $(
                                      ".site-header .container > .logo-header .logo-2"
                                  ).attr("src", "images/logo-2.png"),
                                  $(
                                      ".site-header .container > .logo-header .logo-3"
                                  ).attr("src", "images/logo-3.png"))
                ...
                $("#checkAll").on("change", function () {
                    $(".product-tag-group input:checkbox").prop(
                        "checked",
                        $(this).prop("checked")
                    );
                }),
