  ...
  <div class="card-body">
    <div class="search mt-2 mb-5">
      <div class="buttons mb-2">
        <a href="/admin/brand/create" type="button" class="btn btn-outline-primary btn-sm">+ Add brand</a>
              ...
              <td class="text-center">
                <div class="btn-group">
                  <form action="/admin/brand/{{$brand->id}}" method="POST">
                    @method('DELETE')
                    @csrf
                    <a href="/admin/brand/{{$brand->id}}/edit" type="button" class="btn btn-outline-primary btn-sm">Edit</a> <!-- Added btn-sm class -->
