                    ...
                    <div class="container-fluid flex-grow-1 container-p-y">
                        ...
                        <div class="col-xl">
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <form action="/admin/parts/{{ $carParts->id }}" method="POST"
                                        ...
                                        <div class="row">
                                            <div class="mb-3 col">
                                                ...
                                                <input type="text" class="form-control" id="basic-default-fullname"
                                                    placeholder="name" name="name" value="{{ $carParts->name }}">
                                                @error('name')
                                            ...
                                            <div class="mb-3 col">
                                                ...
                                                <input type="text" class="form-control" id="basic-default-fullname"
                                                    placeholder="price" name="price" value="{{ $carParts->price }}">
                                                @error('price')
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="mb-3 col">
                                                ...
                                                <input type="text" class="form-control"
                                                    ...
                                                    name="count" value="{{ $carParts->count }}">
                                                @error('count')
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            <div class="mb-3 col">
                                                ...
                                                <input type="text" class="form-control"
                                                    ...
                                                    name="warranty" value="{{ $carParts->warranty }}">
                                                @error('warranty')
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="mb-3 col">
                                                ...
                                                <input type="text" class="form-control"
                                                    ...
                                                    name="sale_price" value="{{ $carParts->sale_price }}">
                                                @error('sale_price')
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            <div class="mb-3 col">
                                                ...
                                                <input type="text" class="form-control"
                                                    ...
                                                    name="sale_amount" value="{{ $carParts->sale_amount }}">
                                                @error('sale_amount')
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="mb-3 col">
                                                ...
                                                <input type="file" multiple class="form-control" id="cover"
                                                    name="cover">
                                                @error('cover')
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
