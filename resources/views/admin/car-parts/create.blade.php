                    ...
                    <form action="/admin/parts" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="mb-3 col">
                              ...
                              <div class="mb-3 col">
                                ...
                                <input type="text" class="form-control" id="basic-default-fullname" placeholder="old_price" name="old_price" value="{{ old('old_price') }}">
                                @error('old_price')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                              </div>
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col">
                                ...
                                <input type="text" class="form-control" id="basic-default-fullname" placeholder="enter code" name="code" value="{{ old('code') }}">
                                @error('code')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="mb-3 col">
                                ...
                                <input type="text" class="form-control" id="basic-default-fullname" placeholder="enter count" name="count" value="{{ old('count') }}">
                                @error('count')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="mb-3 col">
                                ...
                                <input type="text" class="form-control" id="basic-default-fullname" placeholder="enter warranty" name="warranty" value="{{ old('warranty') }}">
                                @error('warranty')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="mb-3 col">
                                ...
                                <input type="text" class="form-control" id="basic-default-fullname" placeholder="enter Sale Price" name="sale_price" value="{{ old('sale_price') }}">
                                @error('sale_price')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="mb-3 col">
                                ...
                                <input type="text" class="form-control" id="basic-default-fullname" placeholder="enter sale amount" name="sale_amount" value="{{ old('sale_amount') }}">
                                @error('sale_amount')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
