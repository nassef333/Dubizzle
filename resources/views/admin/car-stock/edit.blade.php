                      ...
                      <div class="row">
                        <div class="mb-3 col">
                            ...
                            <select class="form-control" id="basic-default-fullname" name="status">
                                ...
                                <option value="Used - like new" {{ $carStock->status === 'Used - like new' ? 'selected' : '' }}>Used - like new</option>
                                <option value="Used - Good" {{ $carStock->status === 'Used - Good' ? 'selected' : '' }}>Used - Good</option>
                                <option value="Used - Fair" {{ $carStock->status === 'Used - Fair' ? 'selected' : '' }}>Used - Fair</option>
                            </select>
                            @error('status')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
