      ...
      <div class="card-body">
        <form action="/admin/category" method="POST" enctype="multipart/form-data">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="basic-default-fullname" placeholder="Category" name="name" value="{{ old('name') }}">
            @error('name')
          ...
          <div class="mb-3">
            ...
            <textarea id="basic-default-message" class="form-control" placeholder="Please type Category Description Here..." name="description">{{ old('discreption') }}</textarea>
            @error('description')
            <div class="text-danger">{{ $message }}</div>
            @enderror
          </div>
