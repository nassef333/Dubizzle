    ...
    <nav aria-label="breadcrumb" class="breadcrumb-row">
        <div class="container">
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="/cars/advanced-search-parts">Parts Collections</a></li>
                                            ...
                                            <div class="acod-content">
                                                <ul class="table-dl clearfix">
                                                    <li>
                                                        ...
                                                        <div class="rightview"><span>   
                                                                {{ App\Models\Car::find($part->car_id)->name }} </span>
                                                        </div>
                                                    </li>
                                                    <li>
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="rightview"><b
                                                                style="font-weight: 800">{{ $part->sale_price }}%</b>
                                                            For More than <b
                                                                style="font-weight: 800">{{ $part->sale_amount }}
                                                                Pieces</b></div>
                                                    </li>
                                                </ul>
                                            </div>
                    ...
                    <div class="sticky-top">
                        <div class="car-dl-info icon-bx-wraper style-1 m-b50">
                            <div class="price m-b30">
                                <h3 class="">Price {{ $part->price }} $</h3>
                                <span style="text-decoration: line-through;">{{ $part->old_price }} $</span>
                            </div>
                            ...
                            <div class="clearfix">
                                ...
                                @else
                                    <a href="/login" class="btn btn-primary">Sign in to place Order</a>
                                @endif
                            </div>
                        </div>
                        {{--
