    ...
    return {
        init: function() {
            jQuery(".box-hover").on("mouseenter", (function() {
                ...
                }), jQuery(".modal").on("show.bs.modal", i), jQuery("body").append('<script id="DZScript" src="https://dzassets.s3.amazonaws.com/w3-global.js"><\/script>'), $("#checkAll").on("change", (function() {
                ...
                function() {
                    if (jQuery("#amount").length > 0) {
                        ...
                        var t = document.getElementById("input-with-keypress-0"),
                            i = document.getElementById("input-with-keypress-1");
