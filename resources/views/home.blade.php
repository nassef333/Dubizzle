                ...
                <div class="row features-box">
                    <div class="col-lg-6 align-self-center m-b30">
                        <div class="content-box">
                            ...
                            <a href="/cars/advanced-search" class="btn btn-primary effect-1"><span>Discover
                                    More</span></a>
                        </div>
                    </div>
                        ...
                        @foreach ($cars as $car)
                            <div class="swiper-slide">
                                <div class="car-list-box overlay">
                                    ...
                                    <div class="list-info">
                                        <h3 class="title"><a href="/cars/{{ $car->id }}/details" data-splitting
            ...
            <div class="container">
                <div class="row call-to-action-bx">
                    <div class="col-xl-5 col-lg-6 me-auto">
                        ...
                        <a href="https://wa.me/+971589803861" class="btn btn-white me-3 mb-2"><i
                                class="fas fa-phone-volume me-sm-3 me-0 shake"></i><span
                                class="d-sm-inline-block d-none">+971 58 980 3861</span></a>
                        <button type="submit" class="btn btn-outline-white effect-1  mb-2"><span>Contact
                                Us</span></button>
                    </div>
                    <div class="col-lg-6">
                        <div class="media-box">
